...
export default {
  ...
  "setting.remote.setup_table": "\n| 方式 | 详情参考 |\n| --- | --- |\n| 私有服务器自行搭建 | 速度好，自由配置，无隐私风险，访问 <a href='https://github.com/ZC-eto/fast-note-sync-service'>https://github.com/ZC-eto/fast-note-sync-service</a> 获取搭建帮助 |",
  ...
  "setting.sync.safe_revision": "安全多端同步",
  "setting.sync.safe_revision_desc": "使用资源修订和操作幂等保护多设备修改、删除与重命名。首次开启会校验本地与服务端清单。",
  "setting.sync.safe_revision_status": "当前状态：${status}",
  "setting.sync.safe_revision_status_disabled": "未启用",
  "setting.sync.safe_revision_status_unsupported": "服务端或 PostgreSQL 用户库暂不支持",
  "setting.sync.safe_revision_status_activating": "正在激活",
  "setting.sync.safe_revision_status_bootstrapping": "正在建立安全基准",
  "setting.sync.safe_revision_status_active": "已启用",
  "setting.sync.safe_revision_status_strict-vault-local-disabled": "服务端已严格启用，本机已暂停",
  "setting.sync.safe_revision_status_error": "发生错误，已暂停",
  "setting.sync.safe_revision_confirm_title": "启用安全多端同步",
  "setting.sync.safe_revision_confirm_message": "将校验当前笔记库与服务端清单。只有零差异时才会启用严格修订同步；发现差异会取消激活，不会自动上传、覆盖或删除。",
  "setting.sync.safe_revision_pause_title": "暂停本机安全同步",
  "setting.sync.safe_revision_pause_message": "这只会暂停本机。服务端仍保持严格模式，旧同步协议不会恢复；本机重新启用前的修改可能需要手动处理差异。",
  ...
  "setting.sync.safe_help_tooltip": "安全多端同步是什么？",
  "setting.sync.safe_help_title": "安全多端同步",
  "setting.sync.safe_help_intro": "此模式会用服务端修订号保护每一次写入。权威覆盖是独立的手动维护操作，执行前一定会先展示差异预览。",
  "setting.sync.safe_help_revision": "修订保护：落后的设备不能悄悄覆盖远端更新版本。",
  "setting.sync.safe_help_roles": "设备角色：双向端可上传和下载；本地发布端会临时阻止其他设备写入；远端镜像端只下载。",
  ...
  "setting.sync.role_local_publisher": "本地发布端",
  "setting.sync.role_remote_mirror": "远端镜像端",
  "setting.sync.role_managed_readonly": "此开关现由“当前设备角色”管理。双向端和本地发布端关闭只读，远端镜像端开启只读。",
  "setting.sync.role_managed_offline_delete": "远端镜像端不得上传本地删除，此开关已由设备角色锁定。",
  "setting.sync.mirror_actions": "权威覆盖",
  "setting.sync.mirror_actions_desc": "先生成差异预览，再用一端完整替换另一端。此功能独立于“完整同步”和按时间合并设置。",
  "setting.sync.mirror_local": "本地 -> 远端",
  "setting.sync.mirror_local_desc": "以当前 Vault 为权威副本，替换远端内容。",
  "setting.sync.mirror_remote": "远端 -> 本地",
  "setting.sync.mirror_remote_desc": "以服务端为权威副本，替换本地内容。",
  "setting.sync.mirror_rollback": "恢复最近一次权威覆盖",
  "setting.sync.mirror_rollback_done": "最近一次权威覆盖已恢复，并通过最终校验。",
  "setting.sync.mirror_rollback_confirm_title": "确认恢复最近一次覆盖",
  "setting.sync.mirror_rollback_confirm_message": "这会用恢复包重新改写上次权威覆盖的目标端。覆盖后新产生的同路径修改也可能被替换，请确认已检查当前内容。",
  "setting.sync.mirror_rollback_confirm_action": "执行恢复",
  "setting.sync.mirror_preparing": "正在生成差异预览...",
  "setting.sync.mirror_already_equal": "本地与远端内容已经一致。",
  "setting.sync.mirror_done": "权威覆盖已完成，并通过最终哈希校验。",
  "setting.sync.mirror_local_title": "预览：本地覆盖远端",
  "setting.sync.mirror_remote_title": "预览：远端覆盖本地",
  "setting.sync.mirror_create": "新建",
  "setting.sync.mirror_update": "更新",
  "setting.sync.mirror_delete": "删除",
  "setting.sync.mirror_replace": "替换类型",
  "setting.sync.mirror_high_risk": "本计划会删除或替换大量目标项目，请逐项检查后再继续。",
  "setting.sync.mirror_risk_confirm": "高风险确认",
  "setting.sync.mirror_risk_confirm_desc": "准确输入确认词后才能解锁覆盖按钮。",
  "setting.sync.mirror_risk_phrase": "确认覆盖",
  "setting.sync.mirror_more": "另有 ${count} 项变更未展示",
  "setting.sync.mirror_apply": "执行覆盖",
  "setting.sync.mirror_phase_backup": "保存恢复包",
  "setting.sync.mirror_phase_apply": "执行变更",
  "setting.sync.mirror_phase_verify": "校验哈希",
  "setting.sync.mirror_phase_rollback": "正在恢复",
};
